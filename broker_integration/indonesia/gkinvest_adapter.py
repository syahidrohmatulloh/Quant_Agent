"""Gkinvest adapter stub.

Integration status: mock_only
...
class GkinvestAdapter(BaseBrokerAdapter):
    ...
    def health_check(self) -> Dict[str, Any]:
        return unhealthy("integration_status", "mock_only")
    ...
    def submit_paper_order(self, symbol: str, direction: str, volume: float, price: float) -> Dict[str, Any]:
        return {
            "executed": False,
            "reason": "Gkinvest adapter is stub/mock only.",
