"""OandaSg regional adapter stub.

Integration status: api_possible
...
class OandaSgAdapter(BaseBrokerAdapter):
    ...
    def health_check(self) -> Dict[str, Any]:
        return unhealthy("integration_status", "api_possible")
    ...
    def submit_paper_order(self, symbol: str, direction: str, volume: float, price: float) -> Dict[str, Any]:
        return {
            "executed": False,
            "reason": "OandaSg adapter is stub/mock only.",
