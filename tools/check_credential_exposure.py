...
def main():
    parser = argparse.ArgumentParser(description="Check credential exposure")
    ...
    audit = run_credential_audit(project_root, config.include_dirs, config.exclude_dirs)

    print(f"Credential audit: {audit.pass_count} pass, {audit.warning_count} warning, {audit.fail_count} fail")
