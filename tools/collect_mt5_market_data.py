#!/usr/bin/env python3
"""
CLI tool to collect MT5 OHLCV and export to CSV/JSONL.
...
def main():
    parser = argparse.ArgumentParser(description="Collect MT5 OHLCV market data")
    ...
    try:
        client.initialize()
        bars = client.copy_rates_from_pos(args.symbol, args.timeframe, args.count)
        print(f"Fetched {len(bars)} bars for {args.symbol} {args.timeframe}")
